    ...
    <div id="main-content" class="main-content mc-content flex flex-col selfclear">
        ...
        <div role="main" id="content" class="content selfclear relative">
            ...
            <div class="line section">
                <form action="{{ action('CategoryControlle@store') }}" method="POST" novalidate="novalidate">
                    <div class="unit size1of2 !margin-bottom--lv6">
                        <fieldset>
                            <div id="basicinfo-fieldset">
                                <div id="username-fieldset">
                                    <div class="field-wrapper">
                                        <label for="title" class="">Title</label> <input type="text" name="title" class=" av-text" value="" id="title">
{{--                                        <div class="field-help">This is what you use to log in to Mailchimp. You can also enter your email if you wish.</div>--}}
                                    </div>
                                </div>
                                <div class="field-wrapper">
                                    <label for="description" class="">Description</label> <textarea  type="description" name="description" class=" av-text" value="" id="description"></textarea>
{{--                                    <div class="field-help">Your email address will remain private.</div>--}}
                                ...
                                <a href="{{ action('CategoryControlle@index') }}" class="cancel-button small-meta font-weight--bold">Cancel</a>
                            </div>
                        </fieldset>
                    </div>

                    <input type="hidden" name="__csrf_token" id="" value="9409587c31fead444fd6861a9e786956dd8ee1f1" class="av-hidden">
                </form>
            </div>
