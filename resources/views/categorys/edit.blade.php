    ...
    <div id="main-content" class="main-content mc-content flex flex-col selfclear">
        ...
        <div role="main" id="content" class="content selfclear relative">
            ...
            <div class="line section">
                <form action="{{ action('CategoryController@update', $category->id) }}" method="POST" novalidate="novalidate">
                            ...
                            <div id="basicinfo-fieldset">
                                <div id="username-fieldset">
                                    <div class="field-wrapper">
                                        ...
                                        <input type="text" name="title" class=" av-text {{ $errors->has('title') ? ' is-invalid' : '' }}" value="{{$category->title}}" id="title">
                                ...
                                <div class="field-wrapper">
                                    ...
                                    <input  type="text" name="description" class=" av-text" value="{{$category->description}}" id="description">
